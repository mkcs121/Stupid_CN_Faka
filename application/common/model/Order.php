...
class Order extends Model
{
    ...
    public function selfChannel()
    {
        return $this->belongsTo('SelfChannel','channel_id');
    }

    public function user_channel(){
        return $this->belongsTo('UserSelfChannel','channel_id');
    }
    public function channelSelfAccount(){
        return $this->belongsTo('SelfChannelAccount','channel_account_id');
    }
