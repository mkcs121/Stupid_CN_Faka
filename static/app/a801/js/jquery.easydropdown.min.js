...
(function(d) {
	...
	e.prototype = {
		...
		render: function() {
			...
			a.$scrollWrapper = d("<div style='height: 0px;overflow: hidden' class='select_tousu'><ul/></div>").appendTo(a.$container);
...
//					a.down || a.disabled ? a.close() : a.open()
		...
		close: function() {
			...
			this.$scrollWrapper.css({height: "0px",overflow:'hidden'});
